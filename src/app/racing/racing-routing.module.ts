...
import { CourseShow2Component } from './course-show2/course-show2.component'; // error handling demo using async pipe

const routes: Routes = [
  { path: '', component: CourseListComponent, resolve: { lookups: LookupResolver} },
  { path: 'routes/:id', component: CourseShowComponent},
  { path: 'routes2/:id', component: CourseShow2Component}, // demo
